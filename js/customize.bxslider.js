$(document).ready(function(){
    var respSlider = $('.slider').bxSlider({
...
function responsiveSlider(target){
    var currentViewport;
    /*
    ...
    */
    $(window).resize(function(){
        ...
        if(currentViewport >= 1280){
            target.reloadSlider();
            console.log('reload Desktop!');
        }else if(currentViewport >= 768){
            target.reloadSlider();
            console.log('reload tablet!');
        }else{
            target.reloadSlider();
